...
**Live app:** https://cpq.worksquares.ai · **API:** https://cpq-api.worksquares.ai · **Docs:** https://docs.worksquares.ai
...
**Do not report security vulnerabilities as public issues.** Use [private vulnerability reporting](https://github.com/worksquares/cpq-issues/security/advisories/new) instead — see [SECURITY.md](SECURITY.md).
